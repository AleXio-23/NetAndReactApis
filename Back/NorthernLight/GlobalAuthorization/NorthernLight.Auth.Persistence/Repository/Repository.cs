...
namespace NorthernLight.Auth.Persistence.Repository
{
    public class Repository<TEntity>(AuthorizationDbContext context) : IRepository<TEntity> where TEntity : class
    {

        protected readonly AuthorizationDbContext _context = context;
